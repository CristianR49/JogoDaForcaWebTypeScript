class ForcaIndexView{
    ...
    txtPalavraMisteriosaUnderLine : HTMLHeadingElement;
    txtLetrasErradas : HTMLHeadingElement;
    txtChute : HTMLInputElement;
    btnChute : HTMLButtonElement;
    txtNotificacao : HTMLHeadingElement;
    btnTentarNovamente : HTMLButtonElement;
    imgForca : HTMLImageElement;
    palavras = ["ABACATE","ABACAXI","ACEROLA","ACAI","ARACA","ABACATE","BACABA","BACURI","BANANA"
    ...
    palavraMisteriosa : string;
    palavraMisteriosaUnderLine : string;
    chute : string;
    erros = 0;
    ...
    registrarElementos()
    {
        this.txtPalavraMisteriosaUnderLine = document.getElementById('txtPalavraMisteriosa') as HTMLHeadingElement;
        this.txtLetrasErradas = document.getElementById('txtLetrasErradas') as HTMLHeadingElement;
        this.txtChute = document.getElementById('txtChute') as HTMLInputElement;
        this.btnChute = document.getElementById('btnChute') as HTMLButtonElement;
        this.txtNotificacao = document.getElementById('txtNotificacao') as HTMLHeadingElement;
        this.btnTentarNovamente = document.getElementById('btnTentarNovamente') as HTMLButtonElement;
        this.imgForca = document.getElementById('imgForca') as HTMLImageElement;
    }
    ...
    avaliarChute()
    {
        ...
        let palavraUnderLineEmArray: string[] = this.txtPalavraMisteriosaUnderLine.textContent?.split('') || [];
        let novaPalavra = "";
        this.txtChute.value = "";
